...
const variants = {
  ...
  [ButtonVariant.SECONDARY]: 'bg-dark-accent text-white hover:bg-zinc-700 focus-visible:ring-primary-500/50 border border-dark-border',
  [ButtonVariant.OUTLINE]: 'border border-dark-border bg-transparent text-zinc-300 hover:border-primary-400 hover:text-primary-400 focus-visible:ring-primary-500/50',
